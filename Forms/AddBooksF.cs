...
{
    public partial class AddBooksF : Form
    {
        ...
        private void addBooks_addBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter a valid number for Total Copies", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        public void ClearFields()
        {
            ...
            addBooks_copies.Text = "";
            addBooks_published.Value = DateTime.Now;
        }
